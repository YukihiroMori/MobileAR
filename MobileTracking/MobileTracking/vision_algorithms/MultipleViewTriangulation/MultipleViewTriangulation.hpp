...
namespace MultipleViewTriangulation {
   ...
   // Correct Points
   bool correct_triplet_tensor(Matrix3d tfT[],
                               const Vector3d& x0i,
                               const Vector3d& x1i,
                               const Vector3d& x2i,
                               Vector3d& x0c,
   ...
   bool optimal_correction(std::vector<std::vector<Matrix3d>> tfT,
                           int CNum,
   ...
   // correct all points for every camera.
    bool optimal_correction_all(std::vector<Matrix34d> Proj,
                               int CamNumAll,
   ...
   bool triangulation_all(std::vector<Matrix34d> Prj,
                          int CamNum,
                          std::vector<MatrixXd> x,
                          std::vector<Vector3d> Xr,
                          int PtNum,
                          const MatrixXi& idx,
                          double f0 = Default_f0);
}
