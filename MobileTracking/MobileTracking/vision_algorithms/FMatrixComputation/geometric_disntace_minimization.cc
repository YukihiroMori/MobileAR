...
FMatrixComputation::geometric_distance_minimization(
   std::vector<Vector2d> p0,// Data:                      INPUT
   std::vector<Vector2d> p1,     // Data:                      INPUT
...
{
   std::vector<Vector2d> p0h(Num), p1h(Num);       // hat x, y, x', and y'
   std::vector<Vector2d> p0t(Num), p1t(Num);       // tilde x, y, x', and y'
   std::vector<Vector9d> Xst(Num);                 // Xi*
