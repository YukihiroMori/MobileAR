//
// Common functions for homography computation
//
...
// set xi1
Vector9d
HomographyComputation::set_xi1(const Vector2d& pos0, const Vector2d& pos1, double f0)
{
   Vector9d xi1;
...
// set xi2
Vector9d
HomographyComputation::set_xi2(const Vector2d& pos0, const Vector2d& pos1, double f0)
{
   Vector9d xi2;
...
// set xi3
Vector9d
HomographyComputation::set_xi3(const Vector2d& pos0, const Vector2d& pos1, double f0)
{
   Vector9d xi3;
   xi3 <<
      -pos0(0)*pos1(1), -pos0(1)*pos1(1), -f0*pos1(1),
...
// set xi1 from vec4
Vector9d
HomographyComputation::set_xi1(const Vector4d& pos, double f0)
{
   Vector9d xi1;
...
// set xi2 from vec4
Vector9d
HomographyComputation::set_xi2(const Vector4d& pos, double f0)
{
   Vector9d xi2;
...
// set xi3 from vec4
Vector9d
HomographyComputation::set_xi3(const Vector4d& pos, double f0)
{
   Vector9d xi3;
   xi3 <<
...
// set Ta1
void
HomographyComputation::set_Ta1(Matrix94d& Ta1, const Vector2d& pos0, const Vector2d& pos1, double f0)
{
   Ta1(3,0) = Ta1(4,1) = -f0;
...
// set Ta2
void
HomographyComputation::set_Ta2(Matrix94d& Ta2, const Vector2d& pos0, const Vector2d& pos1, double f0)
{
   Ta2(0,0) = Ta2(1,1) = f0;
...
// set Ta3
void
HomographyComputation::set_Ta3(Matrix94d& Ta3, const Vector2d& pos0, const Vector2d& pos1, double f0)
{
...
// set Ta1 from vec4
void
HomographyComputation::set_Ta1(Matrix94d& Ta1, const Vector4d& pos, double f0)
{
   Ta1(3,0) = Ta1(4,1) = -f0;
...
// set Ta2 from vec4
void
HomographyComputation::set_Ta2(Matrix94d& Ta2, const Vector4d& pos, double f0)
{
   Ta2(0,0) = Ta2(1,1) = f0;
...
// set Ta3 from vec4
void
HomographyComputation::set_Ta3(Matrix94d& Ta3, const Vector4d& pos, double f0)
{
...
Matrix9d
HomographyComputation::trancated_generalized_inverse(
...
void
HomographyComputation::sample_unique_indices(
